...
public class TemperatureRecordController implements KafkaController<TemperatureRecord>{
    ...
    private com.itorii.kafkaDemo.common.avro.TemperatureRecord toAvro(TemperatureRecord temperatureRecord) {
        return com.itorii.kafkaDemo.common.avro.TemperatureRecord.newBuilder()
